...
#define SAMPLE_DEVICE_NAME          "ESP_GATTS_SKI"
...
TaskHandle_t takeSamplesTask = NULL;
...
static uint8_t raw_adv_data[] = {
        ...
        0x03, 0x03, 0xFF, 0x00,
        /* device name */
        0x0f, 0x09, 'E', 'S', 'P', '_', 'G', 'A', 'T', 'T', 'S', '_', 'S','K', 'I'
};
...
static const uint8_t char_value[4]                 = {0x11, 0x22, 0x33, 0x44}; //vjv se ovo mora TODO
double *ski_sensor_value = NULL;


static const char *SAMPLES_TAG = "SAMPLES";
...
static const esp_gatts_attr_db_t gatt_db[HRS_IDX_NB] =
{
    ...
    /* Characteristic Value ovdje sam svoje zamjenio*/
    [IDX_CHAR_VAL_A] =
    {{ESP_GATT_AUTO_RSP}, {ESP_UUID_LEN_16, (uint8_t *)&GATTS_CHAR_UUID_TEST_A, ESP_GATT_PERM_READ | ESP_GATT_PERM_WRITE,
      GATTS_DEMO_CHAR_VAL_LEN_MAX, sizeof(char_value), (uint8_t *)char_value}},
...
void take_samples(void *params) {
    ESP_LOGE(SAMPLES_TAG,"---Taking samples---\n"); 
...
void stop_sampling() {
   vTaskDelete(takeSamplesTask); 
   mpu6050_deinit();
   ESP_LOGE(SAMPLES_TAG,"---Ended sampeling---\n"); 
}
